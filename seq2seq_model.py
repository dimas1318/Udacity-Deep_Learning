...
class Seq2SeqModel(object):
  ...
  def __init__(self, source_vocab_size, target_vocab_size, buckets, size,
    ...
    single_cell = tf.python.ops.rnn_cell.GRUCell(size)
    if use_lstm:
      single_cell = tf.python.ops.rnn_cell.BasicLSTMCell(size)
    cell = single_cell
    if num_layers > 1:
      cell = tf.python.ops.rnn_cell.MultiRNNCell([single_cell] * num_layers)
